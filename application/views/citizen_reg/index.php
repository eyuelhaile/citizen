<div class="card mb-4">
    ...
    <script type="text/javascript">
     var check_edit = "<?php if($citizen['id'] == 0) echo 0; else echo 1;?>";
    ...
    $(document).ready(function () {
     ...
     $("form").submit(function (event) {
      ...
      var formData = {
        id       : (check_edit) ? "<?php echo $citizen['id']; ?>" : 0,
      ...
      var save_url = "";
      if(check_edit == 1) save_url = "citizen_reg/update_citizen";
      else save_url = "citizen_reg/save_citizen";
      console.log(save_url);
      formData2 = new FormData(this);
      if(check_edit == 1)
         formData2.append('id', "<?php echo $citizen['id']; ?>");
      $.ajax({
        type: "POST",
        url: save_url,
        data: formData2,
     ...
     if(check_edit){
        $("#firstName").val("<?php echo $citizen['fname']; ?>");
        $("#lastName").val("<?php echo $citizen['lname']; ?>");
        $("#email").val("<?php echo $citizen['email']; ?>");
        $("#age").val("<?php echo $citizen['age']; ?>");
        $("#phoneNumber").val("<?php echo $citizen['phoneNumber']; ?>");
        $("#sex").val("<?php echo $citizen['sex']; ?>");
        $("#kebele").val("<?php echo $citizen['kebele']; ?>");
        $("#username").val("<?php echo $citizen['username']; ?>");
        $("#region").val("<?php echo $citizen['region_id']; ?>");
        $("#zone").val("<?php echo $citizen['zone_id']; ?>");
        $("#woreda").val("<?php echo $citizen['woreda_id']; ?>");
        $("#img").attr("src", "<?php echo $citizen['profile_pic']; ?>");
     }
  });
