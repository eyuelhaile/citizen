...
class MYPDF extends TCPDF {
    ...
    public $student_id;
    public $birthdate;
    public $grading_scale;
    public $graduation_date;

    function loadingData($graduation_date, $program_type, $college, $department,$student_name,$sex,$enrolment_type,$student_id,$birthdate,$grading_scale, $award_date) {
    	//print_r($college);
    ...
    public function Header() {
       ...
       // $this->SetFont('helvetica', 'B', 10);
        // Title
       // $this->Cell(0, 15, 'WOLLO UNIVERSITY REGISTRAR AND ALUMNI DIRECTORATE', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $html  = '	
			
				<table>			  
				  <tr>
					
					<td width="100%"><div align="center" style="font-size:8px; margin: 0px">WOLLO UNIVERSITY REGISTRAR AND ALUMNI DIRECTORATE</div></td>
				...
				<table>	
					<tr>
					    ...
					    <td width="100%"><div align="center" style="font-size:8px;">REGISTRAR AND ALUMNI DIRECTORATE</div></td>
				...
				<table>	
					<tr>
					    <td width="20%"></td>
					    <td width="60%"><div align="center" style="font-size:8px; ">STUDENT ACADEMIC RECORD </div></td>
					    
					 </tr>	
				</table>';
		$html  .= '<table border="0">
                   <tr border="1">
						<td width="40%" style="font-size:8px;" align="left" style="font-size:8px;" align="left">
							OFFICE OF STUDENT ACADEMIC SUPPORT SERVICE(REGISTRAR)
						</td>
						<td width="30%" style="font-size:8px;" align="left">
						</td>
						<td width="30%" style="font-size:8px;" align="left">
							Degree Awarded Date: '.$this->graduation_date.' G.C
						</td>
					</tr>
					<tr border="1">
						<td width="40%" style="font-size:8px;" align="left" style="font-size:8px;" align="left">
						...
						<td width="30%" style="font-size:8px;" align="left">
							Certificate: '.$this->program_type.'
						</td>
					</tr>
					<tr>
						<td width="40%" style="font-size:8px;" align="left">
				...
				<table border="0">
					<tr border="1">
						<td width="40%" style="font-size:8px;" align="left" style="font-size:8px;" align="left">
							Full Name: '.$this->student_name.'
						</td>
						<td width="30%" style="font-size:8px;" align="left">
							Sex: '.$this->sex.'
						</td>
						<td width="30%" style="font-size:8px;" align="left">
							Admission Classification: '.$this->enrolment_type.'
						</td>
					</tr>
					<tr>
						<td width="40%" style="font-size:8px;" align="left">
							ID Number: '. $this->student_id .'
						</td>
						<td width="30%" style="font-size:8px;" align="left">
							Date of Birth: '.$this->birthdate.' G.C
						</td>
						<td width="30%" style="font-size:8px;" align="left">
							Academic Year: '.$this->award_date.' G.C
						</td>
					</tr>
				</table>';
    ...
    public function Footer() {
        ...
        $this->SetY(-19);
       $html = '<div style="font-size:6px;">GRADING SYSTEM: '.$this->grading_scale['data'][0]['gradescale'].'<br>GRADE VALUES: '.$this->grading_scale['data'][1]['gradescale'].',***=Course Repeated<br>For Project / Senior Paper / Thesis Excellent = A+, Very Good = A, Good = B+, Satisfactory = B, Fail = F';
			  $html .= '<br><b>THE TRANSCRIPT IS OFFICIAL ONLY WHEN SIGNED AND SEALED BY THE REGISTRAR</b>';
			  $html .= '<P STYLE="text-align:left">Date of Issue:________________________________&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     Student Service Center (Registrar): __________________________</p>';
			  $html .= '</div>';
...
class Maintenance extends TCPDF {
    public $staff_name;

    function loadingData($staff_name) {
    	//print_r($college);
       ...
       $html  = '
			<table border=1>
				<tr style="font-weight:bold;font-size:10px;">
				  <td width="50%"  style="background: black; padding: 10px;" align="left"><font face="nyala" >ያዘጋጀው ሃላፊ ስም <u>'.$this->staff_name.'</u></font></td>
				  <td width="25%"  style="background: black; padding: 10px;" align="left"><font face="nyala" >ፊርማ ___________________________</font></td>
				  <td width="25%"  style="background: black; padding: 10px;" align="left"><font face="nyala" >ቀን ___________________________</font></td>
				</tr>
				<tr style="font-weight:bold;font-size:10px;">
				  <td width="50%"  style="background: black; padding: 10px;" align="left"><font face="nyala" >ያረጋገጠው ዳይሬክተር ስም </font></td>
				  <td width="25%"  style="background: black; padding: 10px;" align="left"><font face="nyala" >ፊርማ ___________________________</font></td>
				  <td width="25%"  style="background: black; padding: 10px;" align="left"><font face="nyala" >ቀን ___________________________</font></td>
				</tr>
				<tr style="font-weight:bold;font-size:10px;">
				  <td  rowspan = 3 width="100%"  style="background: black; padding: 10px;" align="left"><font face="nyala" >ማሳሰቢያ ፤- ይህ ቅፅ በሶስት ቅጂ ተሰርቶ የመጀመሪያው ቅጅ ለመ/ቤቱ የበላይ ሀላፊ ይቀርባል፣ ሁለተኛው ቅጅ ለመንግስት ግዢና ንብረት አስተዳደር አጄንሲ የላካል ሶስተኛው ቅጂ በትራንስፖርት ስምሪት ይቀመጣል።</font></td>
				</tr>
			</table>';
	  $this->writeHTML($html, true, false, true, false, '');
    }
        ...
        $html  = '
			<table border=1>
				<tr style="font-weight:bold;font-size:13px;">
				  <td width="80%"  style="background: black; padding: 10px;" align="left"><font face="nyala" >የመንግስት ተሽከርካሪ ወርሀዊ የነዳጅ፣የዘይትና ቅባት የጥገና ወጪ ማጠቃለያ</font></td>
				  <td width="20%"  style="background: black; padding: 10px;" align="left"><font face="nyala" >ቅፅ 03</font></td>
				</tr>
				<tr style="font-weight:bold;font-size:13px;">
				  <td width="80%"  style="background: black; padding: 10px;" align="left"><font face="nyala" >የመስሪያ ቤቱ ስም - ወሎ ዩኒቨርሲቲ</font></td>
				  <td width="20%"  style="background: black; padding: 10px;" align="left"><font face="nyala" ></font></td>
				</tr>
			</table>';
		$this->writeHTML($html, true, false, true, false, '');
    }
}
class CostSharings extends TCPDF {
    public $phone;
    public $fax;
    public $post;

    function loadingData($phone, $fax, $post) {
    	//print_r($college);
       $this->phone = $phone;
       $this->fax = $fax;
       $this->post = $post;
        ...
        $html  = '
			<table border=1>
				<tr style="font-size:24px;">
				  <td width="50%">
				  	<table>
				  		<tr style="font-size:25px;font-family: nyala;font-weight:bold;">
				  			<td align="center"><font style="letter-spacing:2px;">ወሎ  ዩኒቨርቲ </font> </td>
				  		</tr>
				  		<tr style="font-size:15px;font-family: nyala;font-weight:bold;">
				  			<td align="center"><font style="letter-spacing:2px;">የወጪ መጋራት ስርዓት ጽ/ቤት</font></td>
				  		</tr>
				  ...
				  <td width="50%">
				  	<table>
				  		<tr style="font-size:20px;font-family: Times New Roman;font-weight:bold;">
				  			<td align="center">WOLLO UNIVERSITY</td>
				  		</tr>
				  		<tr style="font-size:15px;font-family: Times New Roman;font-weight:bold;">
				  			<td align="center">Cost Sharing Office </td>
				  		</tr>
				...
				<tr style="font-size:15px;">
				  <td align="center" colspan="2"><font face="nyala">ደሴ፥ ኢትዮጵያ</font></td>
				</tr>
				<tr style="font-size:15px;">
				  <td align="center" colspan="2"><font face="Times New Roman">Dessie, Ethiopia</font></td>
				</tr>
				<tr><td align="center" colspan="2">__________________________________________________________________________________</td></tr>	
			</table>';
		$this->writeHTML($html, true, false, true, false, '');
    }
    ...
    public function Footer() {
       ...
       $html  = '
			<table border=1>
				<tr><td align="center" colspan="3">____________________________________________________________________________________________________________</td></tr>					  
				<tr style="font-size:10px;">
				  <td align="left"><font face="Times New Roman">Phone: 251 033 119 0884</font></td>
				  <td align="left"><font face="Times New Roman">Fax: +251 033 551 2478</font></td>
				  <td align="left"><font face="Times New Roman">Post: 208</font></td>
				</tr>							
			</table>';
